...
#################################################
def donothing():
   messagebox.showinfo(VERSION,"[editor] \t ancestor@korea.kr \n\n\t tkf.fkd.gk.wk@gmail.com")
...
style.configure("mystyle.Treeview", font=('Calibri', 11,'normal')) # Modify the font of the headings
...
def apply_skin(widget):
   ...
   def apply_widget_skin(w):
      new_font = font.Font(family="맑은 고딕", size=11) #, weight="bold")
      ...
      if isinstance(widget, tk.Menu):
         ...
         w.configure(font=new_font)
      elif isinstance(w, (tk.Label, tk.Button, tk.Entry)):
         w.configure(font=new_font)
      elif isinstance(w, tkinter.ttk.Treeview):
         style = tkinter.ttk.Style()
         style.configure("mystyle.Treeview", font=('맑은 고딕', 11,'normal'))
         style.configure("mystyle.Treeview.Heading", font=('맑은 고딕', 11,'normal'), relief='ridge')
